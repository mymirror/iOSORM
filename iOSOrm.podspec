#
#  Be sure to run `pod spec lint iOSRealm.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "mymirror"
  # spec.authors            = { "mymirror" => "852171945@qq.com" }
  ...
  spec.source_files  = "realmOrm/iOSRealm/*.{h,m}"
